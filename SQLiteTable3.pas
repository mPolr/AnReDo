...
type
  ...
  public
    ...
    //////////////////////////////////////////////////////////
    ///  modified by DCA on 16/09/2009
//    procedure BindSQL(Query: TSQLiteQuery; const Index: Integer; const Value: String); overload;
    procedure BindSQL(Query: TSQLiteQuery; const Index: Integer; const Value: String; const StaticData: boolean = true); overload;
    ///  end of modification
    //////////////////////////////////////
    /// new procedure added by DCA on 17/09/2009
    procedure ClearBindings(Query: TSQLiteQuery);
    ///  end of adding
...
{$WARNINGS OFF}
procedure TSQLiteDatabase.BindSQL(Query: TSQLiteQuery; const Index: Integer; const Value: String; const StaticData: boolean = true);
var
   PDestructor: TSQLite3Destructor;
begin
  if Assigned(Query.Statement) then begin
     //////////////////////////////////////////////////////////
     ///  modified by DCA on 16/09/2009
     if StaticData then
        PDestructor := Pointer(SQLITE_STATIC)
     else
        PDestructor := Pointer(SQLITE_TRANSIENT);
//    Sqlite3_Bind_Text(Query.Statement, Index, PAnsiChar(Value), Length(Value), Pointer(SQLITE_STATIC))
     Sqlite3_Bind_Text(Query.Statement, Index, PAnsiChar(Value), Length(Value), PDestructor)
     ///  end of modification
     ////////////////////////////////////////////////////////
  end else
...
///////////////////////////////////////////////////////////
/// new procedure added by DCA on 17/09/2009
procedure TSQLiteDatabase.ClearBindings(Query: TSQLiteQuery);
begin
  if Assigned(Query.Statement) then
    SQLite3_ClearBindings(Query.Statement)
  else
    RaiseError('Could not clear bindings to prepared SQL statement', Query.SQL);
end;
///  end of adding
////////////////////////////////////////////////////////
